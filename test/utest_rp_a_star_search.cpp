...
TEST_F(RoutePlannerTest, TestAddNeighbors) {
    ...
    // // std::vector<float> start_neighbor_g_vals{  0.055291083, 0.051776856,0.082997195,0.10671431};
    // std::vector<float> start_neighbor_h_vals{  1.1831238,1.0858033, 1.0998145, 1.1828455};
